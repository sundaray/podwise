...
export async function generateMetadata({
  ...
  const metadata: Metadata = {
    ...
    description:
      "Discover key insights and actionable takeaways from The Nathan Barry Show podcast episodes.",
    alternates: {
      canonical: `https://podwise.org/podcasts/nathan-barry${
        page > 1 ? `?page=${page}` : ""
      }`,
    },
  };
...
export default async function NathanBarryPodcastPage({
  ...
  const sortedPodcasts = [...nathanBarryPodcastList].sort((a, b) => {
