...
description: "Top 10 key takeaways from Greg McKeown's conversation with Chris Williamson about essentialism, success, and focusing on what truly matters in work and life."
...
We've moved from the information age to the "influencer age." While the information age was characterized by [distraction](/podcasts/scott-d-clary/stay-focused-become-indistractable-nir-eyal-habit-procrastination-expert), the influencer age is defined by disorientation. This represents a fundamental shift in how we experience the world and the challenges we face.
