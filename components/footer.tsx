const navigation = {
  ...
  popularPodcasts: [
    ...
    { name: "Daily Stoic", href: "/podcasts/daily-stoic" },
    { name: "Feel Better, Live More", href: "/podcasts/rangan-chatterjee" },
    { name: "The Mel Robbins Podcast", href: "/podcasts/mel-robbins" },
    { name: "A Bit of Optimism", href: "/podcasts/simon-sinek" },
    { name: "Success Story", href: "/podcasts/scott-d-clary" },
    { name: "The Jack Neel Podcast", href: "/podcasts/jack-neel" },
  ],
  legal: [
